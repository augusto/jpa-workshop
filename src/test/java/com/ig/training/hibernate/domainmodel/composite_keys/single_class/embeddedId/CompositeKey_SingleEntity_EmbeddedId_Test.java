...
public class CompositeKey_SingleEntity_EmbeddedId_Test extends AbstractJpaTest {

   @Test
   public void _1_persist() {
      TheaterSeat seat = new TheaterSeat("B", 2);
   ...
   public void _2_retrieve() {
      TheaterSeat seat = em().find(TheaterSeat.class, new TheaterSeatPK("B", 2));
